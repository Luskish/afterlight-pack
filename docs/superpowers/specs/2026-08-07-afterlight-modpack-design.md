...
- **Public-artifact supersession (2026-08-11):** Shane explicitly authorized public distribution of the current `.mrpack` and CurseForge ZIP. This authorization supersedes the friends-only classification above for those launcher archives. Public delivery still requires the exact five-file inventory, strict archive inspection, metadata and checksum binding, and immutable tags and releases.
