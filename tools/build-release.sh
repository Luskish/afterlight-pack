...
if [ "$PACKWIZ_BOOTSTRAP_VERSION" != "$RELEASE_PACKWIZ_BOOTSTRAP_VERSION" ] ||
  [ "$PACKWIZ_BOOTSTRAP_SIZE" != "$RELEASE_PACKWIZ_BOOTSTRAP_SIZE" ] ||
  [ "$PACKWIZ_BOOTSTRAP_SHA256" != "$RELEASE_PACKWIZ_BOOTSTRAP_SHA256" ] ||
  [ "$PACKWIZ_INSTALLER_VERSION" != "$RELEASE_PACKWIZ_INSTALLER_VERSION" ] ||
  [ "$PACKWIZ_INSTALLER_SIZE" != "$RELEASE_PACKWIZ_INSTALLER_SIZE" ] ||
  [ "$PACKWIZ_INSTALLER_SHA256" != "$RELEASE_PACKWIZ_INSTALLER_SHA256" ]; then
...
python3 tools/release_artifacts.py normalize-archive --archive "$MRPACK"
