...
- **Summary:** The requested Task 6 base commit and later ungenerated Task 5 integration fail the committed-corpus regeneration guard because the generated audit and commodity chapter bytes remain deliberately stale until Task 8 owns generation.
