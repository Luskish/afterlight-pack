...
- Task 7 is integrated. Task 8 commits `873ca68`, `1d70420`, and `5e52a01` passed replacement independent review with no findings, and a disposable server emitted 81 acquisition nodes with zero failures in all required logs. The generalized-bed follow-up range through `795bae0` is under independent review.
